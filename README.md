...
- [x] Шаг 1.17 — Экран результата (макет «Результат генерации»)
- [x] Сообщество (`/community`: челлендж, работы, топ, эфир)
- [x] Премиум доступ (`/premium`: тарифы, привилегии, заглушка оплаты)
- [x] Шаг 1.18 — Профиль (`/profile`: квота, история, настройки)
- [x] Предпросмотр сторис (`/stories`: кадр 9:16, фоны, публикация-заглушка)
